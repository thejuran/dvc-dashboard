...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Complete Phase 3: Dashboard home page with summary cards, urgent alerts, and upcoming reservations. Trip Explorer page with date range search showing affordable resort/room options. Updated navigation with Dashboard as landing page.</what-built>
  <how-to-verify>
...
3. Dashboard should show:
   - 4 summary cards (Contracts, Total Points, Available Points, Committed)
   - Urgent alerts section (if any contracts have banking deadlines within 60 days or expirations within 90 days)
   - Upcoming reservations list
4. Click "Trip Explorer" in sidebar nav
5. Enter check-in and check-out dates (e.g., a few weeks from now, 3-night stay)
6. Results should appear automatically showing:
   - Coverage info (how many resorts checked vs skipped)
   - Affordable options as cards with resort name, room type, point cost, and remaining points
